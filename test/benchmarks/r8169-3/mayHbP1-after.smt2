...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x001a #x0000 #b0))
(rule (threadCreate #x0002 #x001b #x0000 #b0))
(rule (threadCreate #x0003 #x001c #x0000 #b0))
...
(rule (st #x000b #x0003 #b0))
(rule (st #x000c #x0003 #b0))
(rule (st #x000d #x0003 #b0))
(rule (st #xf001 #x0003 #b0))
...
(rule (st #xf002 #x0003 #b0))
(rule (st #x0014 #x0003 #b0))
(rule (st #x0015 #x0003 #b0))
...
(rule (lockAcquire #xf001 #x0000 #b0))
...
(rule (threadCreate #x0001 #x001a #x0000 #b1))
(rule (threadCreate #x0002 #x001b #x0000 #b1))
(rule (threadCreate #x0003 #x001c #x0000 #b1))
...
(rule (st #x000b #x0003 #b1))
(rule (st #x000c #x0003 #b1))
(rule (st #x000d #x0003 #b1))
(rule (st #xf001 #x0003 #b1))
(rule (st #x000e #x0003 #b1))
(rule (st #x000f #x0003 #b1))
(rule (st #x0010 #x0003 #b1))
(rule (st #x0011 #x0003 #b1))
(rule (st #x0012 #x0003 #b1))
(rule (st #x0013 #x0003 #b1))
(rule (st #xf002 #x0003 #b1))
(rule (st #x0014 #x0003 #b1))
(rule (st #x0015 #x0003 #b1))
