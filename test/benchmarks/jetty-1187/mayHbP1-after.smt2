...
(rule (threadCreate #x0001 #x0013 #x0000 #b1))
(rule (threadCreate #x0002 #x0014 #x0000 #b1))
...
(rule (impo #x0015 #xf006 #b1))
(rule (impo #xf006 #x0016 #b1))
(rule (impo #x0016 #xf007 #b1))
(rule (impo #xf007 #x0017 #b1))
...
(rule (impo #x001d #x0021 #b1))
(rule (impo #x0020 #x0022 #b1))
...
(rule (dom #x0015 #xf006 #b1))
(rule (dom #xf006 #x0016 #b1))
(rule (dom #x0016 #xf007 #b1))
(rule (dom #xf007 #x0017 #b1))
...
(rule (dom #x001d #x0021 #b1))
(rule (dom #x0021 #x0022 #b1))
(rule (dom #x0022 #x0020 #b1))
...
(rule (postDom #xf004 #x000a #b1))
(rule (postDom #xf005 #xf004 #b1))
(rule (postDom #x000b #xf005 #b1))
...
(rule (postDom #xf006 #x0015 #b1))
(rule (postDom #x0016 #xf006 #b1))
(rule (postDom #xf007 #x0016 #b1))
(rule (postDom #x0017 #xf007 #b1))
