...
define ptr @checkThread1(ptr noundef %0) #0 {
  ...
  store ptr %0, ptr %2, align 8
  call void @nop1()
  %3 = load i32, ptr @cond1_bool, align 4
  %4 = icmp ne i32 %3, 0
  br i1 %4, label %6, label %5
...
6:                                                ; preds = %5, %1
  ...
  %7 = load i32, ptr @a_SHARED, align 4
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %12

9:                                                ; preds = %6
  %10 = load i32, ptr @b_SHARED, align 4
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %19, label %12

12:                                               ; preds = %9, %6
  %13 = load i32, ptr @a_SHARED, align 4
  %14 = icmp eq i32 %13, 1
  br i1 %14, label %15, label %18

15:                                               ; preds = %12
  %16 = load i32, ptr @b_SHARED, align 4
  %17 = icmp eq i32 %16, -1
...
define ptr @checkThread2(ptr noundef %0) #0 {
  ...
  store ptr %0, ptr %2, align 8
  call void @nop1()
  %3 = load i32, ptr @cond2_bool, align 4
  %4 = icmp ne i32 %3, 0
  br i1 %4, label %6, label %5
