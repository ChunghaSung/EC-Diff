...
3:                                                ; preds = %1, %9
  %4 = call i32 @pthread_mutex_lock(ptr noundef @dev_lock)
  %5 = call i32 @pthread_mutex_lock(ptr noundef @sysfs_lock)
...
9:                                                ; preds = %8, %3
  %10 = call i32 @pthread_mutex_unlock(ptr noundef @sysfs_lock)
  %11 = call i32 @pthread_mutex_unlock(ptr noundef @dev_lock)
  br label %3
}
