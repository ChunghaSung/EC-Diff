...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x0017 #x0000 #b0))
(rule (threadCreate #x0002 #x0018 #x0000 #b0))
...
(rule (impo #xf001 #x0007 #b0))
(rule (impo #xf002 #x0008 #b0))
(rule (impo #x0008 #x0009 #b0))
(rule (impo #x0006 #xf002 #b0))
(rule (impo #x0006 #xf001 #b0))
...
(rule (impo #xf005 #x0012 #b0))
(rule (impo #x000f #x0010 #b0))
(rule (impo #x000f #xf004 #b0))
...
(rule (dom #xf001 #x0007 #b0))
(rule (dom #xf002 #x0008 #b0))
(rule (dom #x0008 #x0009 #b0))
(rule (dom #x0006 #xf001 #b0))
(rule (dom #x0006 #xf002 #b0))
...
(rule (dom #xf005 #x0012 #b0))
(rule (dom #x000f #x0010 #b0))
(rule (dom #x000f #xf004 #b0))
...
(rule (postDom #x0007 #xf001 #b0))
(rule (postDom #x0008 #xf002 #b0))
(rule (postDom #x0009 #x0008 #b0))
(rule (postDom #xf002 #x0006 #b0))
