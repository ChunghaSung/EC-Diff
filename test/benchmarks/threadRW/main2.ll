...
define ptr @writer1(ptr noundef %0) #0 {
  ...
  %8 = call i32 @pthread_mutex_lock(ptr noundef @mutex1)
  store i32 1, ptr @cond1_bool, align 4
  %9 = call i32 @pthread_cond_signal(ptr noundef @cond1)
  %10 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  %11 = call i32 @pthread_mutex_unlock(ptr noundef @mutex1)
...
define ptr @reader1(ptr noundef %0) #0 {
  ...
  %10 = load i32, ptr @cond0_bool, align 4
  %11 = icmp ne i32 %10, 0
  br i1 %11, label %14, label %12

12:                                               ; preds = %1
  %13 = call i32 @"\01_pthread_cond_wait"(ptr noundef @cond0, ptr noundef @mutex0)
  br label %14
...
14:                                               ; preds = %12, %1
  ...
  store i32 %17, ptr @y_SHARED, align 4
  %18 = load i32, ptr @y_SHARED, align 4
  %19 = load i32, ptr @x_SHARED, align 4
...
22:                                               ; preds = %14
  %23 = load i32, ptr @r_SHARED, align 4
  %24 = sub nsw i32 %23, 1
  store i32 %24, ptr %3, align 4
  %25 = load i32, ptr %3, align 4
  store i32 %25, ptr @r_SHARED, align 4
  ret ptr null
}
...
define ptr @reader2(ptr noundef %0) #0 {
  ...
  %10 = load i32, ptr @cond1_bool, align 4
  %11 = icmp ne i32 %10, 0
  br i1 %11, label %14, label %12

12:                                               ; preds = %1
  %13 = call i32 @"\01_pthread_cond_wait"(ptr noundef @cond1, ptr noundef @mutex1)
  br label %14

14:                                               ; preds = %12, %1
  %15 = call i32 @pthread_mutex_unlock(ptr noundef @mutex1)
