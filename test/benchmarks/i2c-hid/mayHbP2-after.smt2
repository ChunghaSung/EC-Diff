...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x002c #x0000 #b0))
(rule (threadCreate #x0002 #x002d #x0000 #b0))
...
(rule (read #x001f #x0001 #b0))
(rule (write #x0006 #x0001 #b0))
(rule (write #x000a #x0000 #b0))
(rule (write #x0019 #x0000 #b0))
(rule (write #x001d #x0001 #b0))
(rule (write #x002a #x0000 #b0))
(rule (write #x002b #x0001 #b0))
...
(rule (dom #xf003 #x0024 #b0))
(rule (dom #x0013 #x0014 #b0))
(rule (dom #x0016 #xf002 #b0))
(rule (dom #x0016 #x0025 #b0))
(rule (dom #x001c #x001d #b0))
(rule (dom #x001c #x001f #b0))
(rule (dom #x0021 #x0022 #b0))
(rule (dom #x0021 #xf003 #b0))
...
(rule (postDom #x0024 #xf003 #b0))
(rule (postDom #x0014 #x0013 #b0))
(rule (postDom #x0014 #x0025 #b0))
(rule (postDom #xf002 #x0016 #b0))
(rule (postDom #x001f #x001c #b0))
...
(rule (threadCreate #x0001 #x002c #x0000 #b1))
(rule (threadCreate #x0002 #x002d #x0000 #b1))
...
(rule (dom #xf003 #x0024 #b1))
(rule (dom #x0013 #x0014 #b1))
(rule (dom #x0016 #xf002 #b1))
(rule (dom #x0016 #x0025 #b1))
(rule (dom #x001c #x001d #b1))
(rule (dom #x001c #x001f #b1))
(rule (dom #x0021 #x0022 #b1))
(rule (dom #x0021 #xf003 #b1))
...
(rule (postDom #x0010 #xf001 #b1))
(rule (postDom #xf000 #x0002 #b1))
(rule (postDom #xf000 #x0010 #b1))
(rule (postDom #x0008 #x0005 #b1))
...
(rule (postDom #x0024 #xf003 #b1))
(rule (postDom #x0014 #x0013 #b1))
(rule (postDom #x0014 #x0025 #b1))
(rule (postDom #xf002 #x0016 #b1))
(rule (postDom #x001f #x001c #b1))
...
;; mayHb for p2
(rule (=> (mayHb s1 s2 #b1) (mayHbP2 s1 s2)))
...
(query mayHbP2 :print-answer true)
