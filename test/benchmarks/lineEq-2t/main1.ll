...
define ptr @thread1(ptr noundef %0) #0 {
  ...
  %7 = load i32, ptr @p0_SHARED, align 4
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %13

9:                                                ; preds = %1
  %10 = load i32, ptr @var0_SHARED, align 4
  %11 = load i32, ptr @c0_SHARED, align 4
...
13:                                               ; preds = %9, %1
  ...
  store i32 %14, ptr @p0_SHARED, align 4
  %15 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  %16 = load i32, ptr @p0_SHARED, align 4
  store i32 %16, ptr %4, align 4
  %17 = load i32, ptr %4, align 4
  store i32 %17, ptr @result_SHARED, align 4
  ret ptr null
}
