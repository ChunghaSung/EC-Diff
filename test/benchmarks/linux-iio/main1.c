...
//constants
int CONFIG_IIO_CONSUMERS_PER_TRIGGER_SHARED;
int trig_subirqs_enabled_SHARED;
...
int main() {
    ...
    trigger_use_count_SHARED = 1;
    trigger_has_ops_SHARED = 0;
    trigger_reenable_function_SHARED = 0;
    trigger_ops_has_tryreenable_function_SHARED = 1;
