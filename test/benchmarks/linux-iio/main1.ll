...
define ptr @thread1(ptr noundef %0) #0 {
  ...
  call void @nop1()
  %6 = load i32, ptr @trigger_use_count_SHARED, align 4
  %7 = icmp ne i32 %6, 0
  br i1 %7, label %8, label %51

8:                                                ; preds = %1
  %9 = load i32, ptr %4, align 4
  %10 = load i32, ptr @trig_subirqs_enabled_SHARED, align 4
  %11 = icmp slt i32 %9, %10
  br i1 %11, label %12, label %16

12:                                               ; preds = %8
  %13 = load i32, ptr @trigger_use_count_SHARED, align 4
  store i32 %13, ptr %3, align 4
  %14 = load i32, ptr %3, align 4
  %15 = add nsw i32 %14, 1
  store i32 %15, ptr @trigger_use_count_SHARED, align 4
  br label %48

16:                                               ; preds = %8
  %17 = load i32, ptr @trigger_use_count_SHARED, align 4
  store i32 %17, ptr %3, align 4
  %18 = load i32, ptr %3, align 4
  %19 = add nsw i32 %18, 1
  store i32 %19, ptr @trigger_use_count_SHARED, align 4
  %20 = load i32, ptr @trigger_use_count_SHARED, align 4
  %21 = icmp ne i32 %20, 0
  br i1 %21, label %22, label %47

22:                                               ; preds = %16
  %23 = load i32, ptr @trigger_has_ops_SHARED, align 4
  %24 = icmp ne i32 %23, 0
  br i1 %24, label %25, label %46

25:                                               ; preds = %22
  %26 = load i32, ptr @trigger_ops_has_tryreenable_function_SHARED, align 4
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %28, label %46

28:                                               ; preds = %25
  %29 = load i32, ptr @trigger_reenable_function_SHARED, align 4
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %45

31:                                               ; preds = %28
  %32 = load i32, ptr @trigger_use_count_SHARED, align 4
  %33 = icmp ne i32 %32, 0
...
37:                                               ; preds = %34
  %38 = load i32, ptr @trigger_use_count_SHARED, align 4
  store i32 %38, ptr %3, align 4
  %39 = load i32, ptr %3, align 4
  %40 = add nsw i32 %39, 1
  store i32 %40, ptr @trigger_use_count_SHARED, align 4
  br label %41
...
define ptr @thread2(ptr noundef %0) #0 {
  ...
  store ptr %0, ptr %2, align 8
  call void @nop1()
  %4 = load i32, ptr @trigger_use_count_SHARED, align 4
  store i32 %4, ptr %3, align 4
  %5 = load i32, ptr %3, align 4
  %6 = add nsw i32 %5, 1
  store i32 %6, ptr @trigger_use_count_SHARED, align 4
  call void @nop1()
  ret ptr null
}
