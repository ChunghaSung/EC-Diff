...
5:                                                ; preds = %1
  call void @nop1()
  %6 = load i8, ptr @ref_count_SHARED, align 1
  %7 = add i8 %6, 1
  store i8 %7, ptr @ref_count_SHARED, align 1
  call void @nop1()
  br label %8
...
8:                                                ; preds = %5, %1
  ...
  call void @nop1()
  %10 = load i8, ptr @ref_count_SHARED, align 1
...
6:                                                ; preds = %5, %1
  ...
  %8 = load i8, ptr @destroyed_SHARED, align 1
  %9 = trunc i8 %8 to i1
...
11:                                               ; preds = %6
  %12 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
