...
(rule (dom #xf002 #x0005 #b0))
(rule (dom #x0006 #x0007 #b0))
(rule (dom #x0007 #xf003 #b0))
(rule (dom #xf003 #x0008 #b0))
(rule (dom #x0008 #x0009 #b0))
(rule (dom #x0009 #x000a #b0))
(rule (dom #xf004 #x000b #b0))
(rule (dom #xf005 #x000c #b0))
...
(rule (dom #x000a #xf005 #b0))
(rule (dom #x000e #x000f #b0))
(rule (dom #x000e #x0011 #b0))
...
(rule (postDom #x0005 #xf002 #b0))
(rule (postDom #x0007 #x0006 #b0))
(rule (postDom #xf003 #x0007 #b0))
(rule (postDom #x0008 #xf003 #b0))
(rule (postDom #x0009 #x0008 #b0))
(rule (postDom #x000a #x0009 #b0))
(rule (postDom #x000b #xf004 #b0))
(rule (postDom #x000c #xf005 #b0))
...
(rule (postDom #xf005 #x000a #b0))
(rule (postDom #xf005 #x000b #b0))
