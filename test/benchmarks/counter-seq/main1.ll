...
@count_SHARED = common global i32 0, align 4
...
define ptr @t1_main(ptr noundef %0) #0 {
  ...
  %5 = load i32, ptr @count_SHARED, align 4
  store i32 %5, ptr %3, align 4
  %6 = load i32, ptr %3, align 4
  %7 = add nsw i32 %6, 1
  store i32 %7, ptr %3, align 4
  %8 = load i32, ptr %3, align 4
  store i32 %8, ptr @count_SHARED, align 4
...
define i32 @main() #0 {
  ...
  store i32 0, ptr @count_SHARED, align 4
  ...
  %10 = load i32, ptr @count_SHARED, align 4
  %11 = icmp ne i32 %10, 2
  br i1 %11, label %12, label %13

12:                                               ; preds = %0
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str, i32 noundef 43, ptr noundef @.str.1) #3
  unreachable
