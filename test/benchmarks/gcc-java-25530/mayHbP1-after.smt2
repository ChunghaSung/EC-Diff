...
(rule (impo #x001b #xf004 #b0))
(rule (impo #xf004 #x001c #b0))
(rule (impo #x001c #xf005 #b0))
(rule (impo #xf005 #x001d #b0))
...
(rule (read #x0003 #x0001 #b0))
(rule (read #x000c #x0001 #b0))
(rule (write #x0002 #x0000 #b0))
(rule (write #x0007 #x0001 #b0))
(rule (write #x000b #x0000 #b0))
(rule (write #x0010 #x0001 #b0))
(rule (write #x0016 #x0002 #b0))
(rule (write #x0017 #x0001 #b0))
...
(rule (dom #x001b #xf004 #b0))
(rule (dom #xf004 #x001c #b0))
(rule (dom #x001c #xf005 #b0))
(rule (dom #xf005 #x001d #b0))
...
(rule (postDom #xf004 #x001b #b0))
(rule (postDom #x001c #xf004 #b0))
(rule (postDom #xf005 #x001c #b0))
(rule (postDom #x001d #xf005 #b0))
...
(rule (impo #x0010 #xf003 #b1))
(rule (impo #xf003 #x0011 #b1))
(rule (impo #x000e #x000f #b1))
(rule (impo #x000e #x0010 #b1))
...
(rule (impo #x001b #xf004 #b1))
(rule (impo #xf004 #x001c #b1))
(rule (impo #x001c #xf005 #b1))
(rule (impo #xf005 #x001d #b1))
...
(rule (read #x0003 #x0001 #b1))
(rule (read #x000c #x0001 #b1))
(rule (write #x0002 #x0000 #b1))
(rule (write #x0007 #x0001 #b1))
(rule (write #x000b #x0000 #b1))
(rule (write #x0010 #x0001 #b1))
(rule (write #x0016 #x0002 #b1))
(rule (write #x0017 #x0001 #b1))
...
(rule (dom #x0010 #xf003 #b1))
(rule (dom #xf003 #x0011 #b1))
(rule (dom #x000e #x000f #b1))
(rule (dom #x000e #x0010 #b1))
...
(rule (dom #x001b #xf004 #b1))
(rule (dom #xf004 #x001c #b1))
(rule (dom #x001c #xf005 #b1))
(rule (dom #xf005 #x001d #b1))
...
(rule (postDom #xf003 #x0010 #b1))
(rule (postDom #x0011 #xf003 #b1))
(rule (postDom #x0010 #x000e #b1))
...
(rule (postDom #xf004 #x001b #b1))
(rule (postDom #x001c #xf004 #b1))
(rule (postDom #xf005 #x001c #b1))
(rule (postDom #x001d #xf005 #b1))
