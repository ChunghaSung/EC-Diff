...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x0030 #x0000 #b0))
(rule (threadCreate #x0002 #x0031 #x0000 #b0))
(rule (threadCreate #x0003 #x0032 #x0000 #b0))
(rule (threadJoin #x0001 #xf00c #x0000 #b0))
(rule (threadJoin #x0002 #xf00d #x0000 #b0))
(rule (threadJoin #x0003 #xf00e #x0000 #b0))
...
(rule (st #x001e #x0003 #b0))
(rule (st #x001f #x0003 #b0))
(rule (st #x0020 #x0003 #b0))
(rule (st #xf007 #x0003 #b0))
(rule (st #x0021 #x0003 #b0))
(rule (st #xf008 #x0003 #b0))
(rule (st #xf009 #x0003 #b0))
...
(rule (st #xf00c #x0000 #b0))
(rule (st #x0034 #x0000 #b0))
(rule (st #xf00d #x0000 #b0))
(rule (st #x0035 #x0000 #b0))
(rule (st #xf00e #x0000 #b0))
...
(rule (impo #x000e #xf004 #b0))
(rule (impo #xf004 #x000f #b0))
...
(rule (impo #x0014 #xf005 #b0))
(rule (impo #xf005 #x0015 #b0))
...
(rule (impo #x0033 #xf00c #b0))
(rule (impo #xf00c #x0034 #b0))
(rule (impo #x0034 #xf00d #b0))
(rule (impo #xf00d #x0035 #b0))
(rule (impo #x0035 #xf00e #b0))
(rule (impo #xf00e #x0036 #b0))
...
(rule (lockRelease #xf00b #x0001 #b0))
...
(rule (read #x0015 #x0001 #b0))
(rule (read #x0022 #x0001 #b0))
(rule (write #x000e #x0001 #b0))
(rule (write #x001b #x0001 #b0))
(rule (write #x002f #x0001 #b0))
...
(rule (dom #x000e #xf004 #b0))
(rule (dom #xf004 #x000f #b0))
...
(rule (dom #x0014 #xf005 #b0))
(rule (dom #xf005 #x0015 #b0))
...
(rule (dom #x0033 #xf00c #b0))
(rule (dom #xf00c #x0034 #b0))
(rule (dom #x0034 #xf00d #b0))
(rule (dom #xf00d #x0035 #b0))
(rule (dom #x0035 #xf00e #b0))
(rule (dom #xf00e #x0036 #b0))
...
(rule (postDom #xf004 #x000e #b0))
(rule (postDom #x000f #xf004 #b0))
...
(rule (postDom #xf005 #x0014 #b0))
(rule (postDom #x0015 #xf005 #b0))
...
(rule (postDom #xf00c #x0033 #b0))
(rule (postDom #x0034 #xf00c #b0))
(rule (postDom #xf00d #x0034 #b0))
(rule (postDom #x0035 #xf00d #b0))
(rule (postDom #xf00e #x0035 #b0))
(rule (postDom #x0036 #xf00e #b0))
(rule (threadCreate #x0001 #x0030 #x0000 #b1))
(rule (threadCreate #x0002 #x0031 #x0000 #b1))
(rule (threadCreate #x0003 #x0032 #x0000 #b1))
(rule (threadJoin #x0001 #xf00c #x0000 #b1))
(rule (threadJoin #x0002 #xf00d #x0000 #b1))
(rule (threadJoin #x0003 #xf00e #x0000 #b1))
...
(rule (st #x001e #x0003 #b1))
(rule (st #x001f #x0003 #b1))
(rule (st #x0020 #x0003 #b1))
(rule (st #xf007 #x0003 #b1))
(rule (st #x0021 #x0003 #b1))
(rule (st #xf008 #x0003 #b1))
(rule (st #xf009 #x0003 #b1))
...
(rule (st #xf00c #x0000 #b1))
(rule (st #x0034 #x0000 #b1))
(rule (st #xf00d #x0000 #b1))
(rule (st #x0035 #x0000 #b1))
(rule (st #xf00e #x0000 #b1))
...
(rule (impo #x000e #xf004 #b1))
(rule (impo #xf004 #x000f #b1))
...
(rule (impo #x0014 #xf005 #b1))
(rule (impo #xf005 #x0015 #b1))
...
(rule (impo #x0033 #xf00c #b1))
(rule (impo #xf00c #x0034 #b1))
(rule (impo #x0034 #xf00d #b1))
(rule (impo #xf00d #x0035 #b1))
(rule (impo #x0035 #xf00e #b1))
(rule (impo #xf00e #x0036 #b1))
...
(rule (write #x001b #x0000 #b1))
(rule (write #x002f #x0000 #b1))
...
(rule (dom #x000e #xf004 #b1))
(rule (dom #xf004 #x000f #b1))
...
(rule (dom #x0014 #xf005 #b1))
(rule (dom #xf005 #x0015 #b1))
...
(rule (dom #x0033 #xf00c #b1))
(rule (dom #xf00c #x0034 #b1))
(rule (dom #x0034 #xf00d #b1))
(rule (dom #xf00d #x0035 #b1))
(rule (dom #x0035 #xf00e #b1))
(rule (dom #xf00e #x0036 #b1))
...
(rule (postDom #xf004 #x000e #b1))
(rule (postDom #x000f #xf004 #b1))
...
(rule (postDom #xf005 #x0014 #b1))
(rule (postDom #x0015 #xf005 #b1))
...
(rule (postDom #xf00c #x0033 #b1))
(rule (postDom #x0034 #xf00c #b1))
(rule (postDom #xf00d #x0034 #b1))
(rule (postDom #x0035 #xf00d #b1))
(rule (postDom #xf00e #x0035 #b1))
(rule (postDom #x0036 #xf00e #b1))
