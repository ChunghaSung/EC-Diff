Author: 
This file is based on the aget-0.4 bug report collected in concurrency-bug-master (https://github.com/jieyu/concurrency-bugs)
Second bug is used.

This bug is fixed by conditional_wait and conditional signal statements to force the order between two statements described below.
