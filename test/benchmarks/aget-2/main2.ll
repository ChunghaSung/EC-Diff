...
82:                                               ; preds = %72
  ...
  %85 = call i32 @pthread_mutex_lock(ptr noundef @patchLock)
  store i32 1, ptr @patchVar_SHARED, align 4
  %86 = call i32 @pthread_cond_signal(ptr noundef @patchCond)
  %87 = call i32 @pthread_mutex_unlock(ptr noundef @patchLock)
  %88 = load ptr, ptr %5, align 8
  %89 = load i32, ptr %8, align 4
  %90 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, ptr noundef %88, i32 noundef %89)
...
95:                                               ; preds = %1
  ...
  %97 = load i32, ptr @bwritten_SHARED, align 4
  %98 = sitofp i32 %97 to float
  store float %98, ptr %9, align 4
  %99 = load i32, ptr @req_clength_SHARED, align 4
  ...
  %109 = load float, ptr @signal_waiter.prev, align 4
  %110 = fadd float %109, 5.000000e+00
  %111 = fcmp olt float %108, %110
  br i1 %111, label %112, label %115

112:                                              ; preds = %95
  %113 = load i32, ptr %12, align 4
  %114 = icmp ne i32 %113, 100
...
120:                                              ; preds = %116
  %121 = call i32 @putchar(i32 noundef 46)
  br label %122
...
136:                                              ; preds = %128
  ...
  store float %140, ptr @signal_waiter.prev, align 4
  %141 = call i32 @alarm(i32 noundef 1)
  br label %142
...
147:                                              ; preds = %137, %127
  ...
  %152 = call i32 @pthread_mutex_lock(ptr noundef @patchLock)
  br label %153
...
157:                                              ; preds = %153
  %158 = call i32 @"\01_pthread_cond_wait"(ptr noundef @patchCond, ptr noundef @patchLock)
  br label %153, !llvm.loop !9

159:                                              ; preds = %153
  %160 = call i32 @pthread_mutex_unlock(ptr noundef @patchLock)
  %161 = call i32 @pthread_mutex_lock(ptr noundef @bwritten_mutex)
  %162 = load i32, ptr %14, align 4
  %163 = load i32, ptr @bwritten_SHARED, align 4
  %164 = add nsw i32 %163, %162
  store i32 %164, ptr @bwritten_SHARED, align 4
  %165 = call i32 @pthread_mutex_unlock(ptr noundef @bwritten_mutex)
  br label %166
...
170:                                              ; preds = %166
  ...
  %174 = call ptr @__memset_chk(ptr noundef %171, i32 noundef 512, i64 noundef 0, i64 noundef %173) #5
  %175 = load i32, ptr %10, align 4
  %176 = load ptr, ptr %11, align 8
  %177 = call i64 @"\01_recv"(i32 noundef %175, ptr noundef %176, i64 noundef 512, i32 noundef 0)
...
185:                                              ; preds = %170
  ...
  %192 = call i64 @"\01_pwrite"(i32 noundef %186, ptr noundef %187, i64 noundef %190, i64 noundef %191)
...
194:                                              ; preds = %170
  ...
  %200 = call i64 @"\01_pwrite"(i32 noundef %195, ptr noundef %196, i64 noundef %198, i64 noundef %199)
...
202:                                              ; preds = %194, %185
  ...
  %207 = call i32 @pthread_mutex_lock(ptr noundef @bwritten_mutex)
  %208 = load i32, ptr %14, align 4
  %209 = load i32, ptr @bwritten_SHARED, align 4
  %210 = add nsw i32 %209, %208
  store i32 %210, ptr @bwritten_SHARED, align 4
  %211 = call i32 @pthread_mutex_unlock(ptr noundef @bwritten_mutex)
  %212 = load i32, ptr @bwritten_SHARED, align 4
  %213 = sitofp i32 %212 to float
  store float %213, ptr %17, align 4
  ...
  %224 = load float, ptr @http_get1.prev, align 4
...
235:                                              ; preds = %231
  %236 = call i32 @putchar(i32 noundef 46)
  br label %237
...
246:                                              ; preds = %243
  %247 = call i32 @putchar(i32 noundef 32)
  br label %248
...
251:                                              ; preds = %243
  ...
  %253 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %252)
  %254 = load i32, ptr %20, align 4
  %255 = sitofp i32 %254 to float
  store float %255, ptr @http_get1.prev, align 4
  br label %256
...
262:                                              ; preds = %261, %257
  ...
  %264 = call i32 @"\01_close"(i32 noundef %263)
  ret ptr null
}
...
148:                                              ; preds = %138, %128
  ...
  %153 = call i32 @pthread_mutex_lock(ptr noundef @patchLock)
  br label %154

154:                                              ; preds = %158, %148
  %155 = load i32, ptr @patchVar_SHARED, align 4
  %156 = icmp ne i32 %155, 0
  %157 = xor i1 %156, true
  br i1 %157, label %158, label %160

158:                                              ; preds = %154
  %159 = call i32 @"\01_pthread_cond_wait"(ptr noundef @patchCond, ptr noundef @patchLock)
  br label %154, !llvm.loop !13

160:                                              ; preds = %154
  %161 = call i32 @pthread_mutex_unlock(ptr noundef @patchLock)
  %162 = call i32 @pthread_mutex_lock(ptr noundef @bwritten_mutex)
  %163 = load i32, ptr %14, align 4
  %164 = load i32, ptr @bwritten_SHARED, align 4
  %165 = add nsw i32 %164, %163
  store i32 %165, ptr @bwritten_SHARED, align 4
  %166 = call i32 @pthread_mutex_unlock(ptr noundef @bwritten_mutex)
  br label %167
...
171:                                              ; preds = %167
  ...
  %174 = call i64 @llvm.objectsize.i64.p0(ptr %173, i1 false, i1 true, i1 false)
  %175 = call ptr @__memset_chk(ptr noundef %172, i32 noundef 512, i64 noundef 0, i64 noundef %174) #5
  %176 = load i32, ptr %10, align 4
  %177 = load ptr, ptr %11, align 8
  %178 = call i64 @"\01_recv"(i32 noundef %176, ptr noundef %177, i64 noundef 512, i32 noundef 0)
...
186:                                              ; preds = %171
  ...
  %193 = call i64 @"\01_pwrite"(i32 noundef %187, ptr noundef %188, i64 noundef %191, i64 noundef %192)
...
195:                                              ; preds = %171
  ...
  %201 = call i64 @"\01_pwrite"(i32 noundef %196, ptr noundef %197, i64 noundef %199, i64 noundef %200)
...
203:                                              ; preds = %195, %186
  ...
  %208 = call i32 @pthread_mutex_lock(ptr noundef @bwritten_mutex)
  %209 = load i32, ptr %14, align 4
  %210 = load i32, ptr @bwritten_SHARED, align 4
  %211 = add nsw i32 %210, %209
  store i32 %211, ptr @bwritten_SHARED, align 4
  %212 = call i32 @pthread_mutex_unlock(ptr noundef @bwritten_mutex)
  %213 = load i32, ptr @bwritten_SHARED, align 4
  ...
  store float %219, ptr %20, align 4
  ...
  %225 = load float, ptr @http_get2.prev, align 4
  %226 = fadd float %225, 5.000000e+00
  %227 = fcmp olt float %224, %226
  br i1 %227, label %228, label %231

228:                                              ; preds = %203
  %229 = load i32, ptr %21, align 4
  %230 = icmp ne i32 %229, 100
...
236:                                              ; preds = %232
  %237 = call i32 @putchar(i32 noundef 46)
  br label %238
...
247:                                              ; preds = %244
  %248 = call i32 @putchar(i32 noundef 32)
  br label %249
...
252:                                              ; preds = %244
  ...
  %254 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %253)
  %255 = load i32, ptr %21, align 4
  %256 = sitofp i32 %255 to float
  store float %256, ptr @http_get2.prev, align 4
  br label %257
...
203:                                              ; preds = %195, %186
  ...
  %223 = load i32, ptr %21, align 4
  %224 = sitofp i32 %223 to float
  %225 = load float, ptr @http_get3.prev, align 4
  %226 = fadd float %225, 5.000000e+00
  %227 = fcmp olt float %224, %226
  br i1 %227, label %228, label %231
...
252:                                              ; preds = %244
  ...
  %255 = load i32, ptr %21, align 4
  %256 = sitofp i32 %255 to float
  store float %256, ptr @http_get3.prev, align 4
  br label %257
...
203:                                              ; preds = %195, %186
  ...
  %223 = load i32, ptr %21, align 4
  %224 = sitofp i32 %223 to float
  %225 = load float, ptr @http_get4.prev, align 4
  %226 = fadd float %225, 5.000000e+00
  %227 = fcmp olt float %224, %226
  br i1 %227, label %228, label %231
...
252:                                              ; preds = %244
  ...
  %255 = load i32, ptr %21, align 4
  %256 = sitofp i32 %255 to float
  store float %256, ptr @http_get4.prev, align 4
  br label %257
