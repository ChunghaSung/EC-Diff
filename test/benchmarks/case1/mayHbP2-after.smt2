...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x0021 #x0000 #b0))
(rule (threadCreate #x0002 #x0022 #x0000 #b0))
...
(rule (lockAcquire #xf001 #x0001 #b0))
(rule (lockRelease #xf002 #x0001 #b0))
...
(rule (read #x0012 #x0000 #b0))
(rule (read #x0014 #x0002 #b0))
(rule (read #x0018 #x0002 #b0))
(rule (write #x0003 #x0000 #b0))
(rule (write #x0005 #x0001 #b0))
(rule (write #x0006 #x0002 #b0))
(rule (write #x0007 #x0003 #b0))
(rule (write #x0009 #x0001 #b0))
(rule (write #x000a #x0002 #b0))
(rule (write #x000b #x0003 #b0))
(rule (write #x0011 #x0000 #b0))
(rule (write #x0013 #x0001 #b0))
(rule (write #x0015 #x0001 #b0))
(rule (write #x0016 #x0003 #b0))
(rule (write #x0017 #x0000 #b0))
(rule (write #x0019 #x0001 #b0))
(rule (write #x001a #x0003 #b0))
...
(rule (postDom #xf002 #x000a #b0))
(rule (postDom #x000b #xf002 #b0))
(rule (postDom #xf003 #x000b #b0))
(rule (postDom #x000c #xf003 #b0))
(rule (postDom #x000d #x000c #b0))
(rule (postDom #x000f #x000e #b0))
(rule (postDom #x0010 #x000f #b0))
(rule (postDom #xf004 #x0010 #b0))
(rule (postDom #x0011 #xf004 #b0))
...
(rule (postDom #xf005 #x0016 #b0))
(rule (postDom #x0017 #xf005 #b0))
(rule (postDom #x0018 #x0017 #b0))
(rule (postDom #x0019 #x0018 #b0))
(rule (postDom #xf006 #x0019 #b0))
(rule (postDom #x001a #xf006 #b0))
(rule (postDom #xf007 #x001a #b0))
(rule (postDom #x001b #xf007 #b0))
