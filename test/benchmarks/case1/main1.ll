...
define ptr @thread1(ptr noundef %0) #0 {
  ...
  %9 = call i32 @pthread_mutex_unlock(ptr noundef @a)
...
define ptr @thread2(ptr noundef %0) #0 {
  ...
  %7 = call i32 @pthread_mutex_lock(ptr noundef @b)
  store i32 1, ptr @x_SHARED, align 4
  %8 = load i32, ptr @y_SHARED, align 4
  store i32 %8, ptr @temp_SHARED, align 4
  %9 = call i32 @pthread_mutex_unlock(ptr noundef @b)
  store i32 5, ptr @z_SHARED, align 4
  %10 = call i32 @pthread_mutex_unlock(ptr noundef @a)
