...
1080:                                             ; preds = %1078, %1072
  ...
  call void @nop1()
  call void @nop1()
  %1083 = load i32, ptr @debug_SHARED, align 4
  %1084 = icmp ne i32 %1083, 0
  br i1 %1084, label %1085, label %1088

1085:                                             ; preds = %1080
  %1086 = load ptr, ptr @__stderrp, align 8
  %1087 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1086, ptr noundef @.str.36) #8
  br label %1088

1088:                                             ; preds = %1085, %1080
  %1089 = call i32 @pthread_mutex_lock(ptr noundef @aworker_lock)
  br label %1090

1090:                                             ; preds = %1093, %1088
  %1091 = load i32, ptr @aworkers_SHARED, align 4
  %1092 = icmp sgt i32 %1091, 0
  br i1 %1092, label %1093, label %1095

1093:                                             ; preds = %1090
  %1094 = call i32 @"\01_pthread_cond_wait"(ptr noundef @aworker_cv, ptr noundef @aworker_lock)
  br label %1090, !llvm.loop !34

1095:                                             ; preds = %1090
  %1096 = call i32 @pthread_mutex_unlock(ptr noundef @aworker_lock)
  %1097 = load i32, ptr @happen_SHARED, align 4
  store i32 %1097, ptr %40, align 4
  %1098 = load i32, ptr @debug_SHARED, align 4
  %1099 = icmp ne i32 %1098, 0
  br i1 %1099, label %1100, label %1109

1100:                                             ; preds = %1095
  %1101 = load ptr, ptr @__stderrp, align 8
  %1102 = load i32, ptr @n_files_SHARED, align 4
  %1103 = load i32, ptr @n_matches_SHARED, align 4
  %1104 = load i32, ptr @nworkers_SHARED, align 4
  %1105 = load i64, ptr @n_bytes_SHARED, align 8
  %1106 = udiv i64 %1105, 1000000
  %1107 = trunc i64 %1106 to i32
  %1108 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1101, ptr noundef @.str.37, i32 noundef %1102, i32 noundef %1103, i32 noundef %1104, i32 noundef %1107) #8
  br label %1109
