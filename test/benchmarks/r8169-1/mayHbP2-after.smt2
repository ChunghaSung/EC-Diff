...
(rule (threadCreate #x0001 #x0024 #x0000 #b1))
(rule (threadCreate #x0002 #x0025 #x0000 #b1))
...
(rule (impo #x0006 #x0008 #b1))
(rule (impo #x0007 #x0004 #b1))
(rule (impo #x000a #x000b #b1))
(rule (impo #x000a #x000d #b1))
(rule (impo #x000c #x000f #b1))
(rule (impo #x000e #x000f #b1))
(rule (impo #x0011 #x0012 #b1))
(rule (impo #x0011 #x0014 #b1))
(rule (impo #x0016 #x0017 #b1))
(rule (impo #x0017 #x0018 #b1))
(rule (impo #x0018 #x001a #b1))
(rule (impo #x001a #x0019 #b1))
(rule (impo #x0019 #x001b #b1))
...
(rule (busyRead #x0004 #x0000 #b1))
(rule (read #x0008 #x0001 #b1))
(rule (read #x000f #x0002 #b1))
(rule (busyWrite #x0019 #x0000 #b1))
(rule (busyWrite #x0021 #x0000 #b1))
(rule (write #x000b #x0002 #b1))
(rule (write #x000d #x0002 #b1))
(rule (write #x001a #x0001 #b1))
(rule (write #x0019 #x0000 #b1))
(rule (write #x0021 #x0000 #b1))
(rule (write #x0022 #x0001 #b1))
(rule (write #x0023 #x0002 #b1))
...
(rule (dom #x0006 #x0008 #b1))
(rule (dom #x000a #x000b #b1))
(rule (dom #x000a #x000d #b1))
(rule (dom #x000a #x000f #b1))
(rule (dom #x0011 #x0012 #b1))
(rule (dom #x0011 #x0014 #b1))
(rule (dom #x0016 #x0017 #b1))
(rule (dom #x0017 #x0018 #b1))
(rule (dom #x0018 #x001a #b1))
(rule (dom #x001a #x0019 #b1))
(rule (dom #x0019 #x001b #b1))
...
(rule (postDom #x0004 #x0007 #b1))
(rule (postDom #x0008 #x0006 #b1))
(rule (postDom #x000f #x000a #b1))
(rule (postDom #x000f #x000c #b1))
(rule (postDom #x000f #x000e #b1))
(rule (postDom #x0017 #x0016 #b1))
(rule (postDom #x0018 #x0017 #b1))
(rule (postDom #x001a #x0018 #b1))
(rule (postDom #x0019 #x001a #b1))
(rule (postDom #x001b #x0019 #b1))
