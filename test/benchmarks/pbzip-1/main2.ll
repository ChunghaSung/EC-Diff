...
53:                                               ; preds = %51, %48
  ...
  %55 = call i32 @pthread_create(ptr noundef %6, ptr noundef null, ptr noundef @fileWriter1, ptr noundef null)
  %56 = call i32 @pthread_create(ptr noundef %8, ptr noundef null, ptr noundef @producer_decompress, ptr noundef null)
  %57 = load ptr, ptr %6, align 8
  %58 = call i32 @"\01_pthread_join"(ptr noundef %57, ptr noundef null)
  br label %70

59:                                               ; preds = %45
  %60 = load i32, ptr @QuietMode_SHARED, align 4
  %61 = icmp ne i32 %60, 1
...
64:                                               ; preds = %62, %59
  %65 = call i32 @pthread_create(ptr noundef %4, ptr noundef null, ptr noundef @consumer1, ptr noundef null)
  %66 = call i32 @pthread_create(ptr noundef %7, ptr noundef null, ptr noundef @fileWriter2, ptr noundef null)
  %67 = call i32 @pthread_create(ptr noundef %9, ptr noundef null, ptr noundef @producer, ptr noundef null)
  %68 = load ptr, ptr %7, align 8
  %69 = call i32 @"\01_pthread_join"(ptr noundef %68, ptr noundef null)
  br label %70
...
73:                                               ; preds = %70
  %74 = load i32, ptr @OutputStdOut_SHARED, align 4
  %75 = icmp eq i32 %74, 0
...
79:                                               ; preds = %78, %70
  ...
  store i64 0, ptr @queue_head_SHARED, align 8
  store i64 0, ptr @queue_tail_SHARED, align 8
  %80 = load i32, ptr @QuietMode_SHARED, align 4
  %81 = icmp ne i32 %80, 1
  br i1 %81, label %82, label %84

82:                                               ; preds = %79
  %83 = call i32 (ptr, ...) @printf(ptr noundef @.str.12)
  br label %84

84:                                               ; preds = %82, %79
  store i32 1, ptr @patchVar_SHARED, align 4
  %85 = load ptr, ptr %2, align 8
  %86 = call i32 @"\01_pthread_join"(ptr noundef %85, ptr noundef null)
  %87 = load ptr, ptr %4, align 8
  %88 = call i32 @"\01_pthread_join"(ptr noundef %87, ptr noundef null)
  %89 = call i32 @pthread_mutex_destroy(ptr noundef @queue_mut)
  %90 = load i32, ptr %20, align 4
  store i32 %90, ptr @queue_mut_SHARED, align 4
  %91 = call i32 @pthread_cond_destroy(ptr noundef @queue_notFull)
  %92 = call i32 @pthread_cond_destroy(ptr noundef @queue_notEmpty)
  %93 = load i32, ptr @QuietMode_SHARED, align 4
  %94 = icmp ne i32 %93, 1
  br i1 %94, label %95, label %97

95:                                               ; preds = %84
  %96 = call i32 (ptr, ...) @printf(ptr noundef @.str.13)
  br label %97
