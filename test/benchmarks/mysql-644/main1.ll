...
@table_SHARED_1 = global i8 65, align 1
@table_SHARED_2 = global i8 65, align 1
@__func__.join_init_cache = private unnamed_addr constant [16 x i8] c"join_init_cache\00", align 1
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define ptr @join_init_cache(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load i8, ptr @table_SHARED_1, align 1
  %4 = sext i8 %3 to i32
  %5 = icmp eq i32 %4, 88
  br i1 %5, label %6, label %7

6:                                                ; preds = %1
  call void @__assert_rtn(ptr noundef @__func__.join_init_cache, ptr noundef @.str, i32 noundef 56, ptr noundef @.str.1) #3
  unreachable

7:                                                ; preds = %1
  %8 = load i8, ptr @table_SHARED_2, align 1
  %9 = sext i8 %8 to i32
  %10 = icmp eq i32 %9, 88
  br i1 %10, label %11, label %12

11:                                               ; preds = %7
  call void @__assert_rtn(ptr noundef @__func__.join_init_cache, ptr noundef @.str, i32 noundef 59, ptr noundef @.str.1) #3
  unreachable

12:                                               ; preds = %7
  %13 = call i32 @pthread_mutex_lock(ptr noundef @mutex0)
  store i32 1, ptr @cond0_bool, align 4
  %14 = call i32 @pthread_cond_signal(ptr noundef @cond0)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define ptr @fix_field(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  %3 = alloca i8, align 1
  store ptr %0, ptr %2, align 8
  %4 = load i8, ptr @table_SHARED_2, align 1
...
10:                                               ; preds = %8, %1
  ...
  store i8 88, ptr @table_SHARED_2, align 1
  %12 = load i8, ptr %3, align 1
  store i8 %12, ptr @table_SHARED_2, align 1
  ret ptr null
}
...
define i32 @main() #0 {
  ...
  %2 = alloca ptr, align 8
  %3 = call i32 @pthread_create(ptr noundef %1, ptr noundef null, ptr noundef @join_init_cache, ptr noundef null)
  %4 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @fix_field, ptr noundef null)
