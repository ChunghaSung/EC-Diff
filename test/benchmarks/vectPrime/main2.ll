...
85:                                               ; preds = %82, %79, %76, %73, %70, %67, %64, %61, %58, %55, %52, %49, %46, %43, %40, %37, %34, %31, %28, %25, %22, %19, %16, %13
  %86 = call i32 @pthread_mutex_lock(ptr noundef @mutex0)
  br label %87

87:                                               ; preds = %85, %82
  %88 = load i32, ptr @res_SHARED, align 4
  %89 = add nsw i32 %88, 1
  store i32 %89, ptr %4, align 4
  %90 = load i32, ptr %4, align 4
  store i32 %90, ptr @res_SHARED, align 4
  %91 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  br label %92
