...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x000a #x0000 #b0))
(rule (threadCondSignal #x0001 #xf001 #b0))
(rule (threadCondWait #x0001 #x0000 #xf004 #b0))
...
(rule (impo #x0003 #xf001 #b0))
(rule (impo #xf001 #xf002 #b0))
(rule (impo #xf002 #x0004 #b0))
...
(rule (impo #xf003 #x000b #b0))
(rule (impo #x000b #x000c #b0))
(rule (impo #x000c #x000d #b0))
(rule (impo #xf004 #x000e #b0))
(rule (impo #xf005 #x000f #b0))
...
(rule (impo #x000d #xf004 #b0))
(rule (impo #x000e #xf005 #b0))
(rule (impo #x0014 #x0015 #b0))
(rule (impo #x0014 #x0017 #b0))
...
(rule (dom #x0003 #xf001 #b0))
(rule (dom #xf001 #xf002 #b0))
(rule (dom #xf002 #x0004 #b0))
...
(rule (dom #xf003 #x000b #b0))
(rule (dom #x000b #x000c #b0))
(rule (dom #x000c #x000d #b0))
(rule (dom #xf004 #x000e #b0))
(rule (dom #xf005 #x000f #b0))
...
(rule (postDom #x000b #xf003 #b0))
(rule (postDom #x000c #x000b #b0))
(rule (postDom #x000d #x000c #b0))
(rule (postDom #x000e #xf004 #b0))
(rule (postDom #x000f #xf005 #b0))
