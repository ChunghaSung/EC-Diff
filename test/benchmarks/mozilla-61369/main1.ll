...
@mthread_state_SHARED = common global i8 0, align 1
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define ptr @threadInit(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = call i32 @pthread_mutex_lock(ptr noundef @mutex0)
  store i32 1, ptr @cond0_bool, align 4
  store i8 65, ptr @mthread_state_SHARED, align 1
  %4 = call i32 @pthread_cond_signal(ptr noundef @cond0)
  %5 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  ret ptr null
}
...
define i32 @main() #0 {
  ...
  store i8 88, ptr @mthread_state_SHARED, align 1
  %4 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @threadInit, ptr noundef null)
...
10:                                               ; preds = %8, %0
  ...
  %12 = load i8, ptr @mthread_state_SHARED, align 1
...
16:                                               ; preds = %10
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str, i32 noundef 77, ptr noundef @.str.1) #3
  unreachable
