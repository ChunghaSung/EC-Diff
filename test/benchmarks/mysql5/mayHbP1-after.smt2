...
(rule (=> (and
       ...
       (diffAtSec s1 s2 l1 p1)))
(rule (threadCreate #x0001 #x001e #x0000 #b0))
(rule (threadCreate #x0002 #x001f #x0000 #b0))
...
(rule (impo #x0008 #xf001 #b0))
(rule (impo #xf001 #x0009 #b0))
...
(rule (impo #x0020 #xf004 #b0))
(rule (impo #xf004 #x0021 #b0))
(rule (impo #x0021 #xf005 #b0))
(rule (impo #xf005 #x0022 #b0))
(rule (impo #x0022 #x0023 #b0))
(rule (impo #x0023 #x0024 #b0))
(rule (impo #x0024 #x0025 #b0))
(rule (impo #x0026 #x0027 #b0))
(rule (impo #x0025 #x0026 #b0))
(rule (impo #x0025 #x0028 #b0))
...
(rule (dom #x0008 #xf001 #b0))
(rule (dom #xf001 #x0009 #b0))
...
(rule (dom #x0020 #xf004 #b0))
(rule (dom #xf004 #x0021 #b0))
(rule (dom #x0021 #xf005 #b0))
(rule (dom #xf005 #x0022 #b0))
(rule (dom #x0022 #x0023 #b0))
(rule (dom #x0023 #x0024 #b0))
(rule (dom #x0024 #x0025 #b0))
(rule (dom #x0026 #x0027 #b0))
(rule (dom #x0025 #x0026 #b0))
(rule (dom #x0025 #x0028 #b0))
...
(rule (postDom #xf001 #x0008 #b0))
(rule (postDom #x0009 #xf001 #b0))
...
(rule (postDom #xf004 #x0020 #b0))
(rule (postDom #x0021 #xf004 #b0))
(rule (postDom #xf005 #x0021 #b0))
(rule (postDom #x0022 #xf005 #b0))
(rule (postDom #x0023 #x0022 #b0))
(rule (postDom #x0024 #x0023 #b0))
(rule (postDom #x0025 #x0024 #b0))
(rule (postDom #x0027 #x0026 #b0))
(rule (threadCreate #x0001 #x001e #x0000 #b1))
(rule (threadCreate #x0002 #x001f #x0000 #b1))
...
(rule (impo #x0008 #xf001 #b1))
(rule (impo #xf001 #x0009 #b1))
...
(rule (impo #x0020 #xf004 #b1))
(rule (impo #xf004 #x0021 #b1))
(rule (impo #x0021 #xf005 #b1))
(rule (impo #xf005 #x0022 #b1))
(rule (impo #x0022 #x0023 #b1))
(rule (impo #x0023 #x0024 #b1))
(rule (impo #x0024 #x0025 #b1))
(rule (impo #x0026 #x0027 #b1))
(rule (impo #x0025 #x0026 #b1))
(rule (impo #x0025 #x0028 #b1))
...
(rule (read #x0005 #x0001 #b1))
(rule (read #x000d #x0000 #b1))
(rule (read #x000f #x0001 #b1))
...
(rule (dom #x0008 #xf001 #b1))
(rule (dom #xf001 #x0009 #b1))
...
(rule (dom #x0020 #xf004 #b1))
(rule (dom #xf004 #x0021 #b1))
(rule (dom #x0021 #xf005 #b1))
(rule (dom #xf005 #x0022 #b1))
(rule (dom #x0022 #x0023 #b1))
(rule (dom #x0023 #x0024 #b1))
(rule (dom #x0024 #x0025 #b1))
(rule (dom #x0026 #x0027 #b1))
(rule (dom #x0025 #x0026 #b1))
(rule (dom #x0025 #x0028 #b1))
...
(rule (postDom #xf001 #x0008 #b1))
(rule (postDom #x0009 #xf001 #b1))
...
(rule (postDom #xf004 #x0020 #b1))
(rule (postDom #x0021 #xf004 #b1))
(rule (postDom #xf005 #x0021 #b1))
(rule (postDom #x0022 #xf005 #b1))
