...
(rule (impo #x000b #xf002 #b0))
(rule (impo #xf002 #x000c #b0))
...
(rule (threadCreate #x0001 #x001b #x0000 #b1))
(rule (threadCreate #x0002 #x001c #x0000 #b1))
...
(rule (impo #x000b #xf002 #b1))
(rule (impo #xf002 #x000c #b1))
...
(rule (impo #x001d #xf004 #b1))
(rule (impo #xf004 #x001e #b1))
...
(rule (dom #x001d #xf004 #b1))
(rule (dom #xf004 #x001e #b1))
...
(rule (postDom #xf004 #x001d #b1))
(rule (postDom #x001e #xf004 #b1))
