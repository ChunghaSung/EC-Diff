...
@.str.6 = private unnamed_addr constant [8 x i8] c"main1.c\00", align 1
...
define ptr @writeSentence_t1(ptr noundef %0) #0 {
  ...
  call void @nop1()
  %9 = load i32, ptr @outcnt_SHARED, align 4
  %10 = icmp eq i32 %9, 0
...
13:                                               ; preds = %12, %11
  %14 = load i32, ptr @outcnt_SHARED, align 4
  %15 = add nsw i32 %14, 1
  store i32 %15, ptr @outcnt_SHARED, align 4
  call void @nop1()
  ret ptr null
}
