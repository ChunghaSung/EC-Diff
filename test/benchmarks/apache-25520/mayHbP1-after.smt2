...
(rule (impo #x0009 #xf000 #b0))
(rule (impo #xf000 #x000a #b0))
...
(rule (impo #x0013 #xf001 #b0))
(rule (impo #xf001 #x0014 #b0))
...
(rule (impo #x001e #xf002 #b0))
(rule (impo #xf002 #x001f #b0))
...
(rule (impo #x0028 #xf003 #b0))
(rule (impo #xf003 #x0029 #b0))
...
(rule (read #x003b #x0002 #b0))
(rule (write #x000d #x0001 #b0))
(rule (write #x000f #x0002 #b0))
(rule (write #x0013 #x0000 #b0))
(rule (write #x0022 #x0001 #b0))
(rule (write #x0024 #x0002 #b0))
(rule (write #x0028 #x0000 #b0))
(rule (write #x0034 #x0001 #b0))
(rule (write #x0035 #x0002 #b0))
(rule (write #x0036 #x0000 #b0))
...
(rule (dom #x0009 #xf000 #b0))
(rule (dom #xf000 #x000a #b0))
...
(rule (dom #x0013 #xf001 #b0))
(rule (dom #xf001 #x0014 #b0))
(rule (dom #x000c #x000d #b0))
(rule (dom #x000c #x000f #b0))
(rule (dom #x000c #x0011 #b0))
...
(rule (dom #x001e #xf002 #b0))
(rule (dom #xf002 #x001f #b0))
...
(rule (dom #x0028 #xf003 #b0))
(rule (dom #xf003 #x0029 #b0))
(rule (dom #x0021 #x0022 #b0))
(rule (dom #x0021 #x0024 #b0))
(rule (dom #x0021 #x0026 #b0))
...
(rule (postDom #xf000 #x0009 #b0))
(rule (postDom #x000a #xf000 #b0))
...
(rule (postDom #xf001 #x0013 #b0))
(rule (postDom #x0014 #xf001 #b0))
(rule (postDom #x0011 #x000c #b0))
(rule (postDom #x0011 #x000e #b0))
...
(rule (postDom #xf002 #x001e #b0))
(rule (postDom #x001f #xf002 #b0))
...
(rule (postDom #xf003 #x0028 #b0))
(rule (postDom #x0029 #xf003 #b0))
(rule (postDom #x0026 #x0021 #b0))
(rule (postDom #x0026 #x0023 #b0))
