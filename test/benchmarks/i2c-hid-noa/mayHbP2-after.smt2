...
(rule (threadCreate #x0001 #x0029 #x0000 #b1))
(rule (threadCreate #x0002 #x002a #x0000 #b1))
...
(rule (impo #xf003 #x0020 #b1))
(rule (impo #x0021 #x0022 #b1))
(rule (impo #x0017 #xf002 #b1))
(rule (impo #x0017 #x0021 #b1))
(rule (impo #x001d #x001e #b1))
(rule (impo #x001d #xf003 #b1))
(rule (impo #x001f #xf003 #b1))
...
(rule (read #x0018 #x0000 #b1))
(rule (read #x001b #x0000 #b1))
(rule (write #x0006 #x0001 #b1))
(rule (write #x000a #x0000 #b1))
(rule (write #x001a #x0000 #b1))
(rule (write #x001e #x0001 #b1))
(rule (write #x0027 #x0000 #b1))
...
(rule (dom #xf003 #x0020 #b1))
(rule (dom #x0021 #x0022 #b1))
(rule (dom #x0017 #xf002 #b1))
(rule (dom #x0017 #x0021 #b1))
(rule (dom #x001d #x001e #b1))
(rule (dom #x001d #xf003 #b1))
...
(rule (postDom #x0020 #xf003 #b1))
(rule (postDom #x0022 #x0021 #b1))
(rule (postDom #xf003 #x001d #b1))
(rule (postDom #xf003 #x001f #b1))
(rule (postDom #x0021 #x0017 #b1))
