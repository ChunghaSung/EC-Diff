...
13:                                               ; preds = %8
  call void @__assert_rtn(ptr noundef @__func__.thread_open, ptr noundef @.str, i32 noundef 28, ptr noundef @.str.1) #3
  unreachable
...
13:                                               ; preds = %12, %6
  %14 = call i32 @pthread_mutex_unlock(ptr noundef @a)
  br label %15
