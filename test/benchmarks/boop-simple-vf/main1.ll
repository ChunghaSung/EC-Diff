...
define ptr @thr2(ptr noundef %0) #0 {
  ...
  call void @nop1()
  %4 = load i32, ptr @usecount_SHARED, align 4
  %5 = add nsw i32 %4, 1
  store i32 %5, ptr @usecount_SHARED, align 4
  %6 = load i32, ptr @locked_SHARED, align 4
  %7 = icmp ne i32 %6, 0
...
7:                                                ; preds = %1
  ...
  %8 = load i32, ptr @usecount_SHARED, align 4
  %9 = sub nsw i32 %8, 1
  store i32 %9, ptr @usecount_SHARED, align 4
  store i32 0, ptr @locked_SHARED, align 4
  br label %11
...
11:                                               ; preds = %10, %7
  %12 = load i32, ptr @usecount_SHARED, align 4
  %13 = sub nsw i32 %12, 1
  store i32 %13, ptr @usecount_SHARED, align 4
  store i32 0, ptr @locked_SHARED, align 4
  %14 = load i32, ptr @usecount_SHARED, align 4
  %15 = icmp ne i32 %14, 0
