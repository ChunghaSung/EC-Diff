...
@.str.18 = private unnamed_addr constant [9 x i8] c"22:26:49\00", align 1
...
define ptr @worker1(ptr noundef %0) #0 {
  ...
  call void @nop1()
  %16 = load i32, ptr @q_occupied_SHARED, align 4
  %17 = icmp sle i32 %16, 0
  br i1 %17, label %18, label %22

18:                                               ; preds = %1
  %19 = load i32, ptr @q_closed_SHARED, align 4
  %20 = icmp ne i32 %19, 0
...
22:                                               ; preds = %21, %18, %1
  %23 = load i32, ptr @q_occupied_SHARED, align 4
  %24 = icmp sgt i32 %23, 0
  br i1 %24, label %25, label %38

25:                                               ; preds = %22
  %26 = load ptr, ptr @q_buf_SHARED, align 8
  %27 = load i32, ptr @q_nextout_SHARED, align 4
  %28 = add nsw i32 %27, 1
  store i32 %28, ptr @q_nextout_SHARED, align 4
  %29 = sext i32 %27 to i64
  %30 = getelementptr inbounds ptr, ptr %26, i64 %29
  %31 = load ptr, ptr %30, align 8
  store ptr %31, ptr %3, align 8
  %32 = load i32, ptr @q_qsize_SHARED, align 4
  %33 = load i32, ptr @q_nextout_SHARED, align 4
  %34 = srem i32 %33, %32
  store i32 %34, ptr @q_nextout_SHARED, align 4
  %35 = load i32, ptr @q_occupied_SHARED, align 4
  %36 = add nsw i32 %35, -1
  store i32 %36, ptr @q_occupied_SHARED, align 4
  store i32 1, ptr %4, align 4
  call void @nop1()
  %37 = call i32 @pthread_cond_signal(ptr noundef @q_less)
  br label %39
...
42:                                               ; preds = %39
  ...
  %45 = call i32 (ptr, i32, ...) @"\01_open"(ptr noundef %44, i32 noundef 0)
...
48:                                               ; preds = %42
  %49 = load i32, ptr @verbose_SHARED, align 4
  %50 = icmp ne i32 %49, 0
  br i1 %50, label %51, label %60

51:                                               ; preds = %48
  %52 = call i32 @pthread_mutex_lock(ptr noundef @print_lock)
  %53 = load ptr, ptr @__stderrp, align 8
  %54 = load ptr, ptr %5, align 8
  %55 = call ptr @__error()
  %56 = load i32, ptr %55, align 4
  %57 = call ptr @"\01_strerror"(i32 noundef %56)
  %58 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %53, ptr noundef @.str.1, ptr noundef %54, ptr noundef %57) #8
  %59 = call i32 @pthread_mutex_unlock(ptr noundef @print_lock)
  br label %60
...
61:                                               ; preds = %42
  ...
  %63 = call i32 @"\01_fstat"(i32 noundef %62, ptr noundef %9)
  %64 = icmp slt i32 %63, 0
  br i1 %64, label %65, label %80

65:                                               ; preds = %61
  %66 = load i32, ptr @verbose_SHARED, align 4
  %67 = icmp ne i32 %66, 0
  br i1 %67, label %68, label %77

68:                                               ; preds = %65
  %69 = call i32 @pthread_mutex_lock(ptr noundef @print_lock)
  %70 = load ptr, ptr @__stderrp, align 8
  %71 = load ptr, ptr %5, align 8
  %72 = call ptr @__error()
  %73 = load i32, ptr %72, align 4
  %74 = call ptr @"\01_strerror"(i32 noundef %73)
  %75 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %70, ptr noundef @.str.2, ptr noundef %71, ptr noundef %74) #8
  %76 = call i32 @pthread_mutex_unlock(ptr noundef @print_lock)
  br label %77

77:                                               ; preds = %68, %65
  %78 = load i32, ptr %6, align 4
  %79 = call i32 @"\01_close"(i32 noundef %78)
  br label %263

80:                                               ; preds = %61
  %81 = getelementptr inbounds %struct.stat, ptr %9, i32 0, i32 11
  %82 = load i64, ptr %81, align 8
  store i64 %82, ptr %7, align 8
  %83 = load i32, ptr @debug_SHARED, align 4
...
85:                                               ; preds = %80
  ...
  %91 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %86, ptr noundef @.str.3, ptr noundef %87, i32 noundef %90) #8
  br label %92

92:                                               ; preds = %85, %80
  %93 = load i64, ptr %7, align 8
  %94 = load i32, ptr %6, align 4
  %95 = call ptr @"\01_mmap"(ptr noundef null, i64 noundef %93, i32 noundef 1, i32 noundef 66, i32 noundef %94, i64 noundef 0)
...
98:                                               ; preds = %92
  %99 = load i32, ptr @verbose_SHARED, align 4
  %100 = icmp ne i32 %99, 0
  br i1 %100, label %101, label %110

101:                                              ; preds = %98
  %102 = call i32 @pthread_mutex_lock(ptr noundef @print_lock)
  %103 = load ptr, ptr @__stderrp, align 8
  %104 = load ptr, ptr %5, align 8
  %105 = call ptr @__error()
  %106 = load i32, ptr %105, align 4
  %107 = call ptr @"\01_strerror"(i32 noundef %106)
  %108 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %103, ptr noundef @.str.4, ptr noundef %104, ptr noundef %107) #8
  %109 = call i32 @pthread_mutex_unlock(ptr noundef @print_lock)
  br label %110

110:                                              ; preds = %101, %98
  %111 = load i32, ptr %6, align 4
  %112 = call i32 @"\01_close"(i32 noundef %111)
  br label %262

113:                                              ; preds = %92
  %114 = load ptr, ptr @rstr_SHARED, align 8
...
117:                                              ; preds = %113
  %118 = call i32 @pthread_mutex_lock(ptr noundef @print_lock)
  %119 = load ptr, ptr %5, align 8
  %120 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, ptr noundef %119)
...
132:                                              ; preds = %129
  ...
  %136 = call i32 @isprint(i32 noundef %135) #9
...
158:                                              ; preds = %153, %148, %143, %138, %132
  %159 = phi i1 [ true, %148 ], [ true, %143 ], [ true, %138 ], [ true, %132 ], [ %157, %153 ]
  br label %160

160:                                              ; preds = %158, %129
  %161 = phi i1 [ false, %129 ], [ %159, %158 ]
...
179:                                              ; preds = %175
  ...
  %181 = load i32, ptr @maxlen_SHARED, align 4
...
186:                                              ; preds = %184
  ...
  %190 = call i32 @isprint(i32 noundef %189) #9
...
192:                                              ; preds = %186
  ...
  %196 = call i32 @putchar(i32 noundef %195)
  br label %223
...
201:                                              ; preds = %197
  %202 = call i32 (ptr, ...) @printf(ptr noundef @.str.8)
  br label %222

203:                                              ; preds = %197
  %204 = load i32, ptr @line_f_SHARED, align 4
  %205 = icmp ne i32 %204, 0
  br i1 %205, label %208, label %206

206:                                              ; preds = %203
  %207 = call i32 (ptr, ...) @printf(ptr noundef @.str.9)
  br label %222
...
209:                                              ; preds = %197, %208
  %210 = load i32, ptr @line_f_SHARED, align 4
...
229:                                              ; preds = %167
  %230 = call i32 (ptr, ...) @printf(ptr noundef @.str.13)
  br label %231
...
235:                                              ; preds = %231
  ...
  %237 = load i32, ptr @maxlen_SHARED, align 4
  %238 = sext i32 %237 to i64
  %239 = icmp ult i64 %236, %238
  br label %240

240:                                              ; preds = %235, %231
  %241 = phi i1 [ false, %231 ], [ %239, %235 ]
...
242:                                              ; preds = %240
  ...
  %246 = call i32 (ptr, ...) @printf(ptr noundef @.str.14, i32 noundef %245)
...
253:                                              ; preds = %252, %125
  %254 = call i32 @putchar(i32 noundef 10)
  %255 = call i32 @pthread_mutex_unlock(ptr noundef @print_lock)
  br label %256

256:                                              ; preds = %253, %116
  %257 = load ptr, ptr %8, align 8
  %258 = load i64, ptr %7, align 8
  %259 = call i32 @"\01_munmap"(ptr noundef %257, i64 noundef %258)
...
266:                                              ; preds = %264, %39
  %267 = load ptr, ptr @__stdoutp, align 8
  %268 = call i32 @fflush(ptr noundef %267)
  store i32 1, ptr @happen_SHARED, align 4
  %269 = call i32 @pthread_mutex_lock(ptr noundef @aworker_lock)
  %270 = load i32, ptr @aworkers_SHARED, align 4
  %271 = add nsw i32 %270, -1
  store i32 %271, ptr @aworkers_SHARED, align 4
  %272 = call i32 @pthread_cond_signal(ptr noundef @aworker_cv)
  %273 = call i32 @pthread_mutex_unlock(ptr noundef @aworker_lock)
  ret ptr null
}
...
1064:                                             ; preds = %1062, %1056
  ...
  call void @nop1()
  call void @nop1()
  %1067 = load i32, ptr @debug_SHARED, align 4
  %1068 = icmp ne i32 %1067, 0
  br i1 %1068, label %1069, label %1072

1069:                                             ; preds = %1064
  %1070 = load ptr, ptr @__stderrp, align 8
  %1071 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1070, ptr noundef @.str.36) #8
  br label %1072

1072:                                             ; preds = %1069, %1064
  %1073 = call i32 @pthread_mutex_lock(ptr noundef @aworker_lock)
  br label %1074

1074:                                             ; preds = %1077, %1072
  %1075 = load i32, ptr @aworkers_SHARED, align 4
  %1076 = icmp sgt i32 %1075, 0
  br i1 %1076, label %1077, label %1079

1077:                                             ; preds = %1074
  %1078 = call i32 @"\01_pthread_cond_wait"(ptr noundef @aworker_cv, ptr noundef @aworker_lock)
  br label %1074, !llvm.loop !28

1079:                                             ; preds = %1074
  %1080 = call i32 @pthread_mutex_unlock(ptr noundef @aworker_lock)
  %1081 = load i32, ptr @happen_SHARED, align 4
  store i32 %1081, ptr %40, align 4
  %1082 = load i32, ptr @debug_SHARED, align 4
  %1083 = icmp ne i32 %1082, 0
  br i1 %1083, label %1084, label %1093

1084:                                             ; preds = %1079
  %1085 = load ptr, ptr @__stderrp, align 8
  %1086 = load i32, ptr @n_files_SHARED, align 4
  %1087 = load i32, ptr @n_matches_SHARED, align 4
  %1088 = load i32, ptr @nworkers_SHARED, align 4
  %1089 = load i64, ptr @n_bytes_SHARED, align 8
  %1090 = udiv i64 %1089, 1000000
  %1091 = trunc i64 %1090 to i32
  %1092 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1085, ptr noundef @.str.37, i32 noundef %1086, i32 noundef %1087, i32 noundef %1088, i32 noundef %1091) #8
  br label %1093

1093:                                             ; preds = %1084, %1079
