...
1064:                                             ; preds = %1062, %1056
  ...
  %1067 = call i32 @pthread_mutex_lock(ptr noundef @q_mtx)
  store i32 1, ptr @q_closed_SHARED, align 4
  %1068 = call i32 @pthread_cond_signal(ptr noundef @q_more)
  %1069 = call i32 @pthread_mutex_unlock(ptr noundef @q_mtx)
  %1070 = load i32, ptr @debug_SHARED, align 4
  %1071 = icmp ne i32 %1070, 0
  br i1 %1071, label %1072, label %1075

1072:                                             ; preds = %1064
  %1073 = load ptr, ptr @__stderrp, align 8
  %1074 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1073, ptr noundef @.str.36) #8
  br label %1075

1075:                                             ; preds = %1072, %1064
  %1076 = call i32 @pthread_mutex_lock(ptr noundef @aworker_lock)
  br label %1077

1077:                                             ; preds = %1080, %1075
  %1078 = load i32, ptr @aworkers_SHARED, align 4
  %1079 = icmp sgt i32 %1078, 0
  br i1 %1079, label %1080, label %1082

1080:                                             ; preds = %1077
  %1081 = call i32 @"\01_pthread_cond_wait"(ptr noundef @aworker_cv, ptr noundef @aworker_lock)
  br label %1077, !llvm.loop !28

1082:                                             ; preds = %1077
  %1083 = call i32 @pthread_mutex_unlock(ptr noundef @aworker_lock)
  %1084 = load i32, ptr @happen_SHARED, align 4
  store i32 %1084, ptr %40, align 4
  %1085 = load i32, ptr @debug_SHARED, align 4
  %1086 = icmp ne i32 %1085, 0
  br i1 %1086, label %1087, label %1096

1087:                                             ; preds = %1082
  %1088 = load ptr, ptr @__stderrp, align 8
  %1089 = load i32, ptr @n_files_SHARED, align 4
  %1090 = load i32, ptr @n_matches_SHARED, align 4
  %1091 = load i32, ptr @nworkers_SHARED, align 4
  %1092 = load i64, ptr @n_bytes_SHARED, align 8
  %1093 = udiv i64 %1092, 1000000
  %1094 = trunc i64 %1093 to i32
  %1095 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1088, ptr noundef @.str.37, i32 noundef %1089, i32 noundef %1090, i32 noundef %1091, i32 noundef %1094) #8
  br label %1096

1096:                                             ; preds = %1087, %1082
