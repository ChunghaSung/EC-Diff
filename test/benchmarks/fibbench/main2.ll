...
6:                                                ; preds = %5, %1
  call void @nop1()
  %7 = load i32, ptr @j_SHARED, align 4
  %8 = load i32, ptr @i_SHARED, align 4
  %9 = add nsw i32 %8, %7
  store i32 %9, ptr @i_SHARED, align 4
...
define i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  call void @nop1()
  %12 = load i32, ptr @i_SHARED, align 4
  %13 = icmp sge i32 %12, 377
  br i1 %13, label %17, label %14

14:                                               ; preds = %2
  %15 = load i32, ptr @j_SHARED, align 4
  %16 = icmp sge i32 %15, 377
