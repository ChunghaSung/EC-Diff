...
(rule (threadCreate #x0001 #x0014 #x0000 #b1))
(rule (threadCreate #x0002 #x0015 #x0000 #b1))
(rule (threadJoin #x0001 #xf000 #x0000 #b1))
(rule (threadJoin #x0002 #xf001 #x0000 #b1))
...
(rule (st #xf000 #x0000 #b1))
(rule (st #x0017 #x0000 #b1))
(rule (st #xf001 #x0000 #b1))
...
(rule (impo #x0016 #xf000 #b1))
(rule (impo #xf000 #x0017 #b1))
(rule (impo #x0017 #xf001 #b1))
(rule (impo #xf001 #x0018 #b1))
...
(rule (dom #x0016 #xf000 #b1))
(rule (dom #xf000 #x0017 #b1))
(rule (dom #x0017 #xf001 #b1))
(rule (dom #xf001 #x0018 #b1))
...
(rule (postDom #xf000 #x0016 #b1))
(rule (postDom #x0017 #xf000 #b1))
(rule (postDom #xf001 #x0017 #b1))
(rule (postDom #x0018 #xf001 #b1))
