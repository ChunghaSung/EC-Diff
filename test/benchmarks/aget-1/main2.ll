...
60:                                               ; preds = %50
  ...
  %63 = call i32 @pthread_mutex_lock(ptr noundef @patchLock)
  store i32 1, ptr @patchVar_SHARED, align 4
  %64 = call i32 @pthread_cond_signal(ptr noundef @patchCond)
  %65 = call i32 @pthread_mutex_unlock(ptr noundef @patchLock)
  %66 = load ptr, ptr %5, align 8
  %67 = load i32, ptr %8, align 4
  %68 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, ptr noundef %66, i32 noundef %67)
...
73:                                               ; preds = %1
  ...
  %75 = load i32, ptr @bwritten_SHARED, align 4
  %76 = sitofp i32 %75 to float
  store float %76, ptr %9, align 4
  %77 = load i32, ptr @req_clength_SHARED, align 4
  ...
  %87 = load float, ptr @signal_waiter.prev, align 4
  %88 = fadd float %87, 5.000000e+00
...
98:                                               ; preds = %94
  %99 = call i32 @putchar(i32 noundef 46)
  br label %100
...
109:                                              ; preds = %106
  %110 = call i32 @putchar(i32 noundef 32)
  br label %111
...
114:                                              ; preds = %106
  ...
  %116 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %115)
  %117 = load i32, ptr %12, align 4
  %118 = sitofp i32 %117 to float
  store float %118, ptr @signal_waiter.prev, align 4
  %119 = call i32 @alarm(i32 noundef 1)
  br label %120
