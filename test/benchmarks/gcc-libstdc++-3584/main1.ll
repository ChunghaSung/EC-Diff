...
@val_SHARED = common global i8 0, align 1
...
define ptr @t1_main(ptr noundef %0) #0 {
  ...
  call void @nop1()
  %5 = load i8, ptr @val_SHARED, align 1
  %6 = sext i8 %5 to i32
  ...
  store i8 %11, ptr @val_SHARED, align 1
  call void @nop1()
  ret ptr null
}
...
define i32 @main() #0 {
  ...
  store i8 0, ptr @val_SHARED, align 1
  ...
  %10 = load i8, ptr @val_SHARED, align 1
  %11 = sext i8 %10 to i32
  %12 = icmp ne i32 %11, 4
  br i1 %12, label %13, label %14

13:                                               ; preds = %0
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str, i32 noundef 79, ptr noundef @.str.1) #3
  unreachable
