...
13:                                               ; preds = %8
  ...
  %79 = call i32 @pthread_mutex_lock(ptr noundef @mutex0)
  store i32 1, ptr @cond0_bool, align 4
  %80 = load i32, ptr @stats_SHARED, align 4
  %81 = icmp eq i32 %80, 0
...
83:                                               ; preds = %13
  %84 = call i32 @pthread_cond_signal(ptr noundef @cond0)
  %85 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  %86 = load i32, ptr %3, align 4
  %87 = load i32, ptr @tp_tx_dropped_SHARED, align 4
  %88 = add nsw i32 %86, %87
  store i32 %88, ptr @stats_SHARED, align 4
  %89 = load i32, ptr @buffertoprint_SHARED, align 4
  store i32 %89, ptr %3, align 4
  %90 = load i32, ptr %3, align 4
  %91 = load i32, ptr @stats_SHARED, align 4
