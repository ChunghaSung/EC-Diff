...
(rule (threadCreate #x0001 #x0007 #x0002 #b1))
(rule (threadCreate #x0002 #x0015 #x0000 #b1))
...
(rule (impo #x0007 #xf000 #b1))
(rule (impo #xf000 #x0008 #b1))
(rule (impo #x0008 #x0009 #b1))
(rule (impo #x0009 #x000a #b1))
(rule (impo #x000a #xf001 #b1))
(rule (impo #xf001 #x000b #b1))
...
(rule (read #x0009 #x0000 #b1))
(rule (read #x000e #x0000 #b1))
(rule (write #x0005 #x0000 #b1))
(rule (write #x0006 #x0001 #b1))
(rule (write #x000a #x0001 #b1))
(rule (write #x000f #x0001 #b1))
...
(rule (dom #x0007 #xf000 #b1))
(rule (dom #xf000 #x0008 #b1))
(rule (dom #x0008 #x0009 #b1))
(rule (dom #x0009 #x000a #b1))
(rule (dom #x000a #xf001 #b1))
(rule (dom #xf001 #x000b #b1))
...
(rule (postDom #xf000 #x0007 #b1))
(rule (postDom #x0008 #xf000 #b1))
(rule (postDom #x0009 #x0008 #b1))
(rule (postDom #x000a #x0009 #b1))
(rule (postDom #xf001 #x000a #b1))
(rule (postDom #x000b #xf001 #b1))
