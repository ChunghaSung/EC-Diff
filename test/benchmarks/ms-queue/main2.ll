...
define ptr @t1_main(ptr noundef %0) #0 {
  ...
  %8 = load i8, ptr @size_SHARED, align 1
  %9 = add i8 %8, 1
  store i8 %9, ptr @size_SHARED, align 1
  %10 = call i32 @pthread_mutex_unlock(ptr noundef @mutex0)
  %11 = load i8, ptr @tail_SHARED, align 1
  %12 = sext i8 %11 to i64
  %13 = getelementptr inbounds [5 x i8], ptr @items_SHARED, i64 0, i64 %12
