...
(rule (=> (or
           ...
           (p2Notp1Rank3 s1 s2 s3 s4 s5 s6))
       (p1p2Equal false)))
(rule (threadCreate #x0001 #x0037 #x0000 #b0))
(rule (threadCreate #x0002 #x0038 #x0000 #b0))
...
(rule (impo #x0007 #x000a #b0))
(rule (impo #x0009 #x0016 #b0))
(rule (impo #x000f #x0010 #b0))
(rule (impo #x000f #x0012 #b0))
(rule (impo #x0015 #x0016 #b0))
(rule (impo #x0018 #x0019 #b0))
(rule (impo #x0019 #x001a #b0))
(rule (impo #x001a #x001b #b0))
(rule (impo #x001b #xf002 #b0))
(rule (impo #xf002 #x001c #b0))
...
(rule (impo #x0024 #xf003 #b0))
(rule (impo #xf003 #x0025 #b0))
...
(rule (impo #x001f #x0022 #b0))
(rule (impo #x0021 #x002e #b0))
(rule (impo #x0027 #x0028 #b0))
(rule (impo #x0027 #x002a #b0))
...
(rule (impo #x0039 #xf004 #b0))
(rule (impo #xf004 #x003a #b0))
(rule (impo #x003a #xf005 #b0))
(rule (impo #xf005 #x003b #b0))
...
(rule (write #x000c #x0000 #b0))
(rule (write #x0012 #x0001 #b0))
(rule (write #x0013 #x0002 #b0))
(rule (write #x001c #x0000 #b0))
(rule (write #x0024 #x0000 #b0))
(rule (write #x002a #x0001 #b0))
(rule (write #x002b #x0002 #b0))
(rule (write #x0034 #x0000 #b0))
(rule (write #x0035 #x0001 #b0))
(rule (write #x0036 #x0002 #b0))
...
(rule (dom #x0007 #x000a #b0))
(rule (dom #x0007 #x0016 #b0))
(rule (dom #x000f #x0010 #b0))
(rule (dom #x000f #x0012 #b0))
(rule (dom #x0018 #x0019 #b0))
(rule (dom #x0019 #x001a #b0))
(rule (dom #x001a #x001b #b0))
(rule (dom #x001b #xf002 #b0))
(rule (dom #xf002 #x001c #b0))
...
(rule (dom #x0024 #xf003 #b0))
(rule (dom #xf003 #x0025 #b0))
...
(rule (dom #x001f #x0022 #b0))
(rule (dom #x001f #x002e #b0))
(rule (dom #x0027 #x0028 #b0))
(rule (dom #x0027 #x002a #b0))
...
(rule (dom #x0039 #xf004 #b0))
(rule (dom #xf004 #x003a #b0))
(rule (dom #x003a #xf005 #b0))
(rule (dom #xf005 #x003b #b0))
...
(rule (postDom #xf003 #x0024 #b0))
(rule (postDom #x0025 #xf003 #b0))
...
(rule (postDom #xf004 #x0039 #b0))
(rule (postDom #x003a #xf004 #b0))
(rule (postDom #xf005 #x003a #b0))
(rule (postDom #x003b #xf005 #b0))
...
(rule (impo #x0007 #x000a #b1))
(rule (impo #x0009 #x0016 #b1))
(rule (impo #x000f #x0010 #b1))
(rule (impo #x000f #x0012 #b1))
(rule (impo #x0015 #x0016 #b1))
(rule (impo #x0018 #x0019 #b1))
(rule (impo #x0019 #x001a #b1))
(rule (impo #x001a #x001b #b1))
(rule (impo #x001b #xf002 #b1))
(rule (impo #xf002 #x001c #b1))
...
(rule (impo #x0024 #xf003 #b1))
(rule (impo #xf003 #x0025 #b1))
...
(rule (impo #x001f #x0022 #b1))
(rule (impo #x0021 #x002e #b1))
(rule (impo #x0027 #x0028 #b1))
(rule (impo #x0027 #x002a #b1))
...
(rule (write #x000c #x0000 #b1))
(rule (write #x0012 #x0001 #b1))
(rule (write #x0013 #x0002 #b1))
(rule (write #x001c #x0000 #b1))
(rule (write #x0024 #x0000 #b1))
(rule (write #x002a #x0001 #b1))
(rule (write #x002b #x0002 #b1))
(rule (write #x0034 #x0000 #b1))
(rule (write #x0035 #x0001 #b1))
(rule (write #x0036 #x0002 #b1))
...
(rule (dom #x0007 #x000a #b1))
(rule (dom #x0007 #x0016 #b1))
(rule (dom #x000f #x0010 #b1))
(rule (dom #x000f #x0012 #b1))
(rule (dom #x0018 #x0019 #b1))
(rule (dom #x0019 #x001a #b1))
(rule (dom #x001a #x001b #b1))
(rule (dom #x001b #xf002 #b1))
(rule (dom #xf002 #x001c #b1))
...
(rule (dom #x0024 #xf003 #b1))
(rule (dom #xf003 #x0025 #b1))
...
(rule (dom #x001f #x0022 #b1))
(rule (dom #x001f #x002e #b1))
(rule (dom #x0027 #x0028 #b1))
(rule (dom #x0027 #x002a #b1))
...
(rule (postDom #xf003 #x0024 #b1))
(rule (postDom #x0025 #xf003 #b1))
